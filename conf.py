...
html_title = 'dclass-tog'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='dclass-tog'
...
course_description = "Duke version of a study for the ITiCSE working group led by Dr. Barbara Ericson, Dr. Janice Pearce, and Dr. Susan Rodger to test code writing problems with Parsons problems as help versus code writing problems with no additional help."
